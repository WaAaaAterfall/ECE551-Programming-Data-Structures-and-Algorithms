...
class Tester {
 public:
  ...
  void testUnsuccessRemove() {
    ...
    assert(il.tail->data == 4 && il.tail->prev->data == 2 &&
           il.tail->prev->prev->data == 1);
  ...
  void testRuleOfThree() {
    ...
    *il2 = *il1;
    ...
    assert(il1->head->data == 4 && il1->head->next->data == 2 && il1->tail->data == 5);
    assert(il2->tail->data == 3);
    assert(il2->head->data == 2);
    il2->addBack(6);
    il2->addFront(7);
    il2->remove(3);
    assert(il1->getSize() == 3 && il1->head->data == 4);
    assert(il2->head->data == 7);
    assert(il2->tail->data == 6);
